...
struct _GlobalConfig
{
  ...
  /* logsigner options */
  gboolean use_mac_mechanism;
  gint hash_func_name;
  void (*hash_func)(const GString *, char *);
  gchar *initkey_file;
  // removed field gchar *seed;
};

struct _GlobalInteract {
  GString *passwd;
  gchar *seed;
};
...
gint cfg_ls_hfo_format_value(gchar *format);
...
GlobalInteract *interactive_input_new(GString *pwd);
